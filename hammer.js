...
var Hammer = {
	events : function() {
		if (!Hammer._eventsFactory) { 
			throw "Events module not found"; 
		}
		return Hammer._eventsFactory;
	},

	css : function() {
		if (!Hammer._cssFactory) { 
			throw "CSS module not found"; 
		}
		return Hammer._cssFactory;
	},

	coordinates : function() {
		if (!Hammer._coordinatesFactory) { 
			throw "Coordinates module not found"; 
		}
		return Hammer._coordinatesFactory;
	},

	drag : function() {
		if (!Hammer._dragFactory) { 
			throw "Drag module not found"; 
		}
		return Hammer._dragFactory;
	},

	dragsort : function() {
		if (!Hammer._dragsortFactory) { 
			throw "Drag and Sort module not found"; 
		}
	...
	cookies : function() {
		if (!Hammer._cookiesFactory) { 
			throw "Cookies module not found"; 
		}
	...
	slider : function() {
		if (!Hammer._sliderFactory) { 
			throw "Slider module not found"; 
		}
